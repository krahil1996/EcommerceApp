...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-3">
        ...
        <div>
          <input
           ...
           sm:w-72 w-full sm:mr-2 mr-1 lg:mb-0 mb-4 py-2 rounded px-2 focus:outline-none"
          />
          <button
            className="bg-teal-400 hover:bg-teal-500 duration-300 px-2 py-2 font-[Poppins]
      ...
      text-center pt-2 text-gray-400 text-sm pb-4 ml-5"
      >
